...
I18N.en = {
  ...
  h_bouts_note:'{n} bouts, all scored. Picks lock at the first bell of the early prelims.',
  change:'Change', h_full_card:'Full card · bout order', vs:'vs', h_add_pick:'Add your pick',
  no_pick_pts:'No pick · 0 pts', standings:'Standings', members:'8 members', members_n:'{n} members', invite_code:'Invite code',
...
I18N.pt = {
  ...
  h_bouts_note:'{n} lutas, todas valendo pontos. Os palpites travam no primeiro gongo das preliminares iniciais.',
  change:'Alterar', h_full_card:'Card completo · ordem das lutas', vs:'vs', h_add_pick:'Faça seu palpite',
  no_pick_pts:'Sem palpite · 0 pts', standings:'Classificação', members:'8 membros', members_n:'{n} membros', invite_code:'Código de convite',
...
I18N.ru = {
  ...
  h_bouts_note:'{n} боёв, все в зачёт. Прогнозы закрываются с первым гонгом ранних прелимов.',
  change:'Изменить', h_full_card:'Полный кард · порядок боёв', vs:'против', h_add_pick:'Добавь прогноз',
  no_pick_pts:'Нет прогноза · 0 очк.', standings:'Таблица', members:'8 участников', members_n:'{n} участников', invite_code:'Код приглашения',
