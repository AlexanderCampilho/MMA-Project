...
function useAppState() {
  ...
  function computeVals(st) {
    ...
    return Object.assign(L, {
      ...
      hasLastSettled: st.settled,
      lastSettledEvent: T('last_settled') + ' · ' + liveEventShortName,
      lastSettledScore: F('you_went_short', { a: settledHits, b: BOUTS.length }),
      lastSettledNote: F('last_note_sim', { p: settledTotal }),
      memberCount: F('members_n', { n: (st.leaderboard || []).length }),
